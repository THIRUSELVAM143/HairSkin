...
const Hairskincare = () => {
  ...
  const healthcaretwins = useSelector((state) => state.healthcaretwins);
    ...
    <div className='container-fluid'>
      <div className="container">
        <div className='text-center'>
          <h3 className='fw-bold'>Hair Skin Care</h3>

        </div>
        <Carousel responsive={responsive} className="mt-4">
          {healthcaretwins.map((item) => (
